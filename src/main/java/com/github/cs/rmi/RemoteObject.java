package com.github.cs.rmi;

import com.github.cs.Connection;

/**
 * Provides access to various settings on a remote object.
 * @see ObjectSpace#getRemoteObject(com.github.cs.Connection, int, Class...)
...
public interface RemoteObject {
    ...
    /**
     * If false, calls to {@link Object#toString()} will return "<proxy>" instead of being invoking the remote method.
     * Default is false.
     **/
