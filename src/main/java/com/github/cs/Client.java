...
public class Client extends Connection implements EndPoint {
    ...
    /**
     * Calls {@link #connect(int, InetAddress, int, int) connect} with the specified timeout
     ...
     * Network hardware may keep a translation table of inside to outside IP addresses and
     * a UDP keep alive keeps this table entry from expiring. Set to zero to disable.
     * Defaults to 19000.
     **/
